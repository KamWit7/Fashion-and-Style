...
const getVariantClasses = (variant: Variants): TagProps => {
  switch (variant) {
    ...
    case 'h3':
      return {
        classes:
          'text-32 md:text-48 font-heading tracking-paragraph font-medium',
        tag: 'h3',
      }
    case 'h4':
      return {
    ...
    case 'h5':
      return {
        classes:
          'text-24 md:text-32 font-heading tracking-paragraph font-medium',
        tag: 'h5',
      }
    case 'h6':
      return {
        classes:
          'text-20 md:text-24 font-heading tracking-paragraph font-medium',
        tag: 'h6',
      }
    case 'p1':
      return {
    ...
    case 'b1':
      return { classes: 'text-16 md:text-20 font-sans tracking-wide', tag: 'p' }
    case 'b2':
      return { classes: 'text-14 md:text-16 font-sans tracking-wide', tag: 'p' }
    case 'label1':
